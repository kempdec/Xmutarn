...
public class NormalizeCSS : CSS
{
    ...
    /// </summary>
    /// <inheritdoc/>
    public NormalizeCSS(bool isMinified) : base(isMinified)
    {
        if (IsMinified)
        {
            ImportMinCSS();
