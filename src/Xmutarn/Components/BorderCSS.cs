...
public class BorderCSS(bool isMinified) : TempCSS(isMinified)
{
    ...
    /// </summary>
    protected override void ImportOldMinCSS() => Import(""".border-divider{display:block;margin:0;height:0;border-top:1px solid var(--theme-dividers, rgba(0, 0, 0, 0.12))}.border-divider_padded{margin:0 1rem}""");
