...
/// </summary>
public class InputCSS : CSS
{
    /// <summary>
    /// Inicializa uma nova instância de <see cref="InputCSS"/>.
    /// </summary>
    /// <inheritdoc/>
    public InputCSS(bool isMinified) : base(isMinified)
    {
        if (IsMinified)
        {
            ImportMinCSS();
