...
/// </summary>
public class TyposCSS : CSS
{
    /// <summary>
    /// Inicializa uma nova instância de <see cref="TyposCSS"/>.
    /// </summary>
    /// <inheritdoc/>
    public TyposCSS(bool isMinified) : base(isMinified)
    {
        if (IsMinified)
        {
            ImportMinCSS();
