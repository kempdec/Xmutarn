...
const banner = `/*! Xmutarn v${pkg.version} (${pkg.repository.url}) | Copyright ${date.getFullYear()} ${pkg.author.name} | Licensed under MIT (${pkg.repository.url.replace(".git", "")}/blob/master/LICENSE) */\n`;
...
gulp.task("copyFilesToDist", ["sass"], () => gulp.src("./dist/**/*")
  .pipe(gulp.dest("./docs/assets")));

gulp.task("default", ["copyFilesToDist"]);
